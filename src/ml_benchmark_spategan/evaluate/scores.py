"""
Evaluation scores and climate indices for model assessment.

This module combines low-level diagnostic functions (RMSE, PSD, bias metrics)
with climate-specific indices (summer days, precipitation extremes, etc.) for
comprehensive evaluation of climate downscaling models.
"""
...
# ============================================================================
# Diagnostic Metrics (RMSE, Bias, PSD)
# ============================================================================
...
def su(
    x: xr.Dataset, var: str, season: str | None = None, threshold: float = 300.0
) -> xr.Dataset:
    """
